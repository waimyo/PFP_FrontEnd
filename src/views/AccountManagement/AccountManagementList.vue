                      ...
                      <v-row dense>
                        <v-col cols="12" md="4" v-if="ishide">
                          <v-autocomplete
                            ...
                            outlined
                            dense
                            placeholder="Account Type ရွေးချယ်ပါ"
                          ></v-autocomplete>
                        </v-col>
                        <v-col cols="12" md="4">
                          <v-text-field
                  ...
                  <v-col cols="12" md="4">
                    <v-card style="background: #03a9f4 !important">
                      ...
                      >
                        <h5>
                          Ministry Account
                          <span style="float: right">{{ mcount }}</span>
                        </h5>
                      </v-col>
                    </v-card>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-card style="background: #03a9f4 !important">
                      <v-col
                        ...
                        md="12"
                        class="white--text"
                        v-if="ishide || showcpuacc"
                      >
                        <h5>
                          CPU Account
                          <span style="float: right">{{ ccount }}</span>
                        </h5>
                      </v-col>
                    </v-card>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-card style="background: #03a9f4 !important">
                      <v-col cols="12" md="12" class="white--text">
                        <h5>
                          DEO Account
                          <span style="float: right">{{ dcount }}</span>
                        </h5>
                      </v-col>
                    </v-card>
                  </v-col>
              ...
              <template v-slot:item="row">
                <tr>
                  <td>
                    ...
                    >
                    <v-btn
                      @click="ShowChangePasswordDialog(row.item)"
                      class="mt-1 mr-2"
                      small
                      outlined
                      color="primary"
      ...
      AccountService.GetById(item.id).then((result) => {
        ...
        if (result.data.role_id == 4) {
          ...
          if (result.data.parent_id > 0) {
            this.$refs.DEOAccountEntryModal.GetCPUAccount(
              result.data.parent_minid
            );
          }
