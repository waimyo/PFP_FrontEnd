  ...
  <div>
    ...
    <div v-show="isExactActive">
      <v-col cols="12" md="12">
        ...
        <v-card>
          <v-card-title>ထွက်စာများ</v-card-title>
          <v-divider></v-divider>
          <v-col cols="12" md="12">
              ...
              <template v-slot:item="row">
                ...
                >
                  <td>
                    ...
                    <router-link
                      :to="{
                        path: '/OutboundLetterList/InboundOutboundLetterDetail',
                        query: {
...
export default {
  ...
  methods: {
    ...
    GetAllData() {
      ...
      // }
      // params.sortBy = params.sortBy[0];
      InboxOutboxService.OutboundList(params, this.fromdate, this.todate).then(
        (result) => {
