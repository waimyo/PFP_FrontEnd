    ...
    <v-col cols="12" md="12">
      <v-row dense>
            ...
            <v-expansion-panels accordion v-model="palne" multiple>
              <v-expansion-panel>
                <v-expansion-panel-header
                  >Data Selection Filters</v-expansion-panel-header
                >
                    ...
                    <v-row dense class>
                      <v-col cols="12" md="3">
                        <v-autocomplete
                          ...
                          item-value="id"
                          autocomplete="off"
                          :items="ministrylistnotincludetrainingForCounts"
                          :disabled="disabledropdown"
                          outlined
                          dense
                          clearable
                          @change="OnChangeMinistryForCount"
                      ...
                      <v-col cols="12" md="3">
                        <v-autocomplete
                          v-model="user_id_count"
                          :items="userlistforcount"
                          item-text="username"
                          item-value="id"
                          autocomplete="off"
                          :disabled="disabledropdowncpu"
                          outlined
                          dense
                          clearable
                          placeholder="All CPU"
                      ...
                      <v-col cols="12" class="text-right mt-n2">
                        <v-btn
                          ...
                          color="primary"
                          class="mr-2"
                          v-on:click="OnChangeByReporDateForChart()"
                          >ရှာမည်</v-btn
                        >
            ...
            <v-col cols="12" md="12" style="background: #03a9f4 !important">
              <v-row dense>
                ...
                <v-col cols="12" md="10" class="text-right white--text">
                  ...
                  <h4 class="white--text" small style="float: right">
                    {{ totalcampaigncount }}
                  </h4>
                </v-col>
              </v-row>
        ...
        <v-col cols="12" md="6">
          <v-card>
            <v-card-title
              >လစဉ် ဆက်သွယ်ခဲ့သည့် ပြည်သူဦးရေ နှင့်
              တုံ့ပြန်မှုအရေအတွက်</v-card-title
            >
            <zingchart
              style="height: 400px"
              :data="MonthlySentAndReceivedChart"
            ></zingchart>
          </v-card>
        </v-col>
        ...
        <v-col cols="12" md="6">
          <v-card>
            <v-card-title
              >လစဉ် အသေးစားအဂတိလိုက်စားမှုနှင့်စပ်လျဉ်း၍
              တုံ့ပြန်မှု</v-card-title
            >
            <zingchart
              style="height: 400px"
              :data="MonthlyCorruptionChart"
            ></zingchart>
          </v-card>
        </v-col>
        <v-col cols="12" md="12">
          <v-card>
            <v-card-title
              >လအလိုက်ဖြည့်သွင်းထားသော ဖုန်းနံပါတ်အရေအတွက်များ</v-card-title
            >
            <zingchart
              style="height: 400px"
              :data="MonthlyPhoNoChartData"
            ></zingchart>
          </v-card>
        </v-col>
        ...
        <v-col cols="12" md="12" v-show="show">
          <v-expansion-panels accordion v-model="panel2" multiple>
            <v-expansion-panel>
              <v-progress-linear
                :active="loadingfortelecomoperator"
                rounded
                indeterminate
                absolute
                top
                ...
                color="warning"
              ></v-progress-linear>
              <v-expansion-panel-header style="font-size: 17px"
                >Telecom Operator တစ်ခုချင်းစီအလိုက် SMS
                အရေအတွက်</v-expansion-panel-header
              >
              <v-expansion-panel-content>
                <v-row dense>
                  <v-col cols="12" md="3">
                    <v-autocomplete
                      v-model="model.ministry_acc_id"
                      item-text="ministry.name"
                      item-value="id"
                      autocomplete="off"
                      :items="ministrylist"
                      @change="OnChangeByMinistry"
                      outlined
                      dense
                      clearable
                  ...
                  <v-col cols="12" class="text-right mt-n1">
                    <v-btn
                      ...
                      color="primary"
                      class="mr-2"
                      v-on:click="GetSmsCountByOperator()"
                      >ရှာမည်</v-btn
                    >
                    ...
                    <v-btn
                      ...
                      outlined
                      color="error"
                      @click="ResetForSmsCountByOprator"
                      >ပြန်လည်ရွေးချယ်မည်</v-btn
                    >
    ...
    GetAllDataForMonthlyNumberOfSentAndReceivedCounts(
      ...
      HomeService.GetAllForSentAndReceivedCount(
        ...
        if (
          ...
          result.data.receivedfornopersent == 0 ||
          result.data.receivedcounts == 0 ||
